...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<nav id="nav-below">
		<div class="nav-next events-nav-later"><?php next_posts_link( __( 'Next <span class="meta-nav">&rarr;</span>' , 'eventorganiser' ) ); ?></div>
		<div class="nav-previous events-nav-newer"><?php previous_posts_link( __( ' <span class="meta-nav">&larr;</span> Previous', 'eventorganiser' ) ); ?></div>
	</nav><!-- #nav-below -->
<?php endif; ?>
